package co.grap.pack.external.api.service;

import co.grap.pack.admin.sync.service.SyncManager;
import co.grap.pack.external.api.mapper.ExternalFestivalMapper;
...
public class JejuFestivalApiService {
     ...
     */
    @Transactional
    public void syncFestivalsFromExternalApi(String sessionId, SyncManager syncManager) {
        try {
