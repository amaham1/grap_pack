...
import co.grap.pack.user.content.model.UserFestivalRequest;
import co.grap.pack.user.content.service.UserFestivalService;
...
public class UserFestivalController {
     ...
     */
    @PostMapping("/request")
    public String createFestivalRequest(@ModelAttribute UserFestivalRequest request,
