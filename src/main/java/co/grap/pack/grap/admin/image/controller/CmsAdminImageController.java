package co.grap.pack.grap.admin.image.controller;
 ...
 */
@Controller
@RequestMapping("/grap/admin/image")
@RequiredArgsConstructor
public class CmsAdminImageController {
    ...
    @ResponseBody
    public List<CmsAdminImage> getImageList(@PathVariable("contentId") Long contentId) {
    ...
    public String uploadImage(
        ...
        return "redirect:/grap/admin/content/form?contentId=" + contentId;
    }
