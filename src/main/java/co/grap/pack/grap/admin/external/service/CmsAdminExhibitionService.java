...
import co.grap.pack.grap.admin.external.mapper.CmsAdminExhibitionMapper;
...
public class CmsAdminExhibitionService {

    private final CmsAdminExhibitionMapper exhibitionMapper;
