...
import co.grap.pack.grap.admin.external.mapper.CmsAdminGasStationMapper;
...
public class CmsAdminGasStationService {

    private final CmsAdminGasStationMapper gasStationMapper;
