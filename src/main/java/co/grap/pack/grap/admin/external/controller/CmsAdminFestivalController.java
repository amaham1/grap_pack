...
@Slf4j
@Controller
@RequestMapping("/grap/admin/external/festivals")
@RequiredArgsConstructor
public class CmsAdminFestivalController {

    private final CmsAdminFestivalService festivalService;
    ...
    public String festivalList(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        model.addAttribute("content", "grap/admin/external/cms-festival-list");
    ...
    public String festivalDetail(@PathVariable("id") Long id, Model model) {
        ...
        if (festival == null) {
            return "redirect:/grap/admin/external/festivals";
        }

        model.addAttribute("festival", festival);
        model.addAttribute("title", "축제/행사 상세");
        model.addAttribute("content", "grap/admin/external/cms-festival-detail");
        return "grap/admin/layout/cms-admin-layout";
    }
    ...
    public String updateMemo(@PathVariable("id") Long id,
        ...
        return "redirect:/grap/admin/external/festivals/" + id;
    }
