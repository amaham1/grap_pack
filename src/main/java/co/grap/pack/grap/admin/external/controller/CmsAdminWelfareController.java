...
@Slf4j
@Controller
@RequestMapping("/grap/admin/external/welfare")
@RequiredArgsConstructor
public class CmsAdminWelfareController {

    private final CmsAdminWelfareService welfareService;
    ...
    public String welfareList(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        model.addAttribute("content", "grap/admin/external/cms-welfare-list");
    ...
    public String welfareDetail(@PathVariable("id") Long id, Model model) {
        ...
        if (welfare == null) {
            return "redirect:/grap/admin/external/welfare";
        }

        model.addAttribute("welfare", welfare);
        model.addAttribute("title", "복지서비스 상세");
        model.addAttribute("content", "grap/admin/external/cms-welfare-detail");
        return "grap/admin/layout/cms-admin-layout";
    }
    ...
    public String updateMemo(@PathVariable("id") Long id,
        ...
        return "redirect:/grap/admin/external/welfare/" + id;
    }
