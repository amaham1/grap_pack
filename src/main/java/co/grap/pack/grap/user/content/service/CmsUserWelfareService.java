...
import co.grap.pack.grap.user.content.mapper.CmsUserWelfareMapper;
...
public class CmsUserWelfareService {

    private final CmsUserWelfareMapper welfareMapper;
     ...
     */
    @Transactional
    public Long createWelfareRequest(CmsUserWelfareRequest request, List<MultipartFile> images, Integer thumbnailIndex) throws IOException {
