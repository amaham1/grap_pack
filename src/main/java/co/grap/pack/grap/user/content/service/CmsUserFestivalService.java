...
import co.grap.pack.grap.user.content.mapper.CmsUserFestivalMapper;
...
public class CmsUserFestivalService {

    private final CmsUserFestivalMapper festivalMapper;
     ...
     */
    @Transactional
    public Long createFestivalRequest(CmsUserFestivalRequest request, List<MultipartFile> images, Integer thumbnailIndex) throws IOException {
