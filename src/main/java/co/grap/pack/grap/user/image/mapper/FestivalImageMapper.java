...
public interface FestivalImageMapper {
     ...
     * @param image 이미지 정보
     */
    void insertImage(FestivalImage image);
     ...
     * @return 이미지 목록
     */
    List<FestivalImage> selectImagesByFestivalId(@Param("festivalId") Long festivalId);
     ...
     * @return 이미지 정보
     */
    FestivalImage selectImageById(@Param("imageId") Long imageId);
     ...
     * @return 썸네일 이미지 정보
     */
    FestivalImage selectThumbnailByFestivalId(@Param("festivalId") Long festivalId);
