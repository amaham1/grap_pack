...
import co.grap.pack.grap.user.image.mapper.ExhibitionImageMapper;
import co.grap.pack.grap.user.image.mapper.FestivalImageMapper;
import co.grap.pack.grap.user.image.mapper.WelfareServiceImageMapper;
import co.grap.pack.grap.user.image.model.ExhibitionImage;
import co.grap.pack.grap.user.image.model.FestivalImage;
import co.grap.pack.grap.user.image.model.WelfareServiceImage;
