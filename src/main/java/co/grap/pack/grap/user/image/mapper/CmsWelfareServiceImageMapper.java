 ...
 */
@Mapper
public interface CmsWelfareServiceImageMapper {

    /**
     * 이미지 등록
     * @param image 이미지 정보
     */
    void insertImage(CmsWelfareServiceImage image);
     ...
     * @return 이미지 목록
     */
    List<CmsWelfareServiceImage> selectImagesByWelfareServiceId(@Param("welfareServiceId") Long welfareServiceId);
     ...
     * @return 이미지 정보
     */
    CmsWelfareServiceImage selectImageById(@Param("imageId") Long imageId);
     ...
     * @return 썸네일 이미지 정보
     */
    CmsWelfareServiceImage selectThumbnailByWelfareServiceId(@Param("welfareServiceId") Long welfareServiceId);
