...
import co.grap.pack.grap.user.content.mapper.CmsUserExhibitionMapper;
import co.grap.pack.grap.user.content.model.CmsUserExhibitionRequest;
import co.grap.pack.grap.user.image.service.CmsUserImageService;
...
public class CmsUserExhibitionService {

    private final CmsUserExhibitionMapper exhibitionMapper;
    private final CmsUserImageService imageService;
     ...
     */
    @Transactional
    public Long createExhibitionRequest(CmsUserExhibitionRequest request, List<MultipartFile> images, Integer thumbnailIndex) throws IOException {
