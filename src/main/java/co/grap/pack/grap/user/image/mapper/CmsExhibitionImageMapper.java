 ...
 */
@Mapper
public interface CmsExhibitionImageMapper {

    /**
     * 이미지 등록
     * @param image 이미지 정보
     */
    void insertImage(CmsExhibitionImage image);
     ...
     * @return 이미지 목록
     */
    List<CmsExhibitionImage> selectImagesByExhibitionId(@Param("exhibitionId") Long exhibitionId);
     ...
     * @return 이미지 정보
     */
    CmsExhibitionImage selectImageById(@Param("imageId") Long imageId);
     ...
     * @return 썸네일 이미지 정보
     */
    CmsExhibitionImage selectThumbnailByExhibitionId(@Param("exhibitionId") Long exhibitionId);
